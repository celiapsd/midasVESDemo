...
public class DatasetListActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ArrayList<String> datasets = getIntent().getExtras().getStringArrayList("com.kitware.midasfilesvisualisation.bundle.DatasetList");
    ...
    mListView.setOnItemClickListener(new OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> adapterView, View view, int pos,
        ...
        curIntent.putExtra("com.kitware.midasfilesvisualisation.bundle.DatasetName",value);
        curIntent.putExtra("com.kitware.midasfilesvisualisation.bundle.DatasetOffset",pos);
