...
JNIEXPORT void JNICALL Java_com_kitware_KiwiViewer_MidasNative_loadDataset(JNIEnv * env, jobject obj, jstring filename, jint builtinDatasetIndex);
...
JNIEXPORT void JNICALL Java_com_kitware_KiwiViewer_MidasNative_handleSingleTouchPanGesture(JNIEnv * env, jobject obj,  jfloat dx, jfloat dy);
JNIEXPORT void JNICALL Java_com_kitware_KiwiViewer_MidasNative_handleTwoTouchPanGesture(JNIEnv * env, jobject obj,  jfloat x0, jfloat y0, jfloat x1, jfloat y1);
JNIEXPORT void JNICALL Java_com_kitware_KiwiViewer_MidasNative_handleTwoTouchPinchGesture(JNIEnv * env, jobject obj,  jfloat scale);
JNIEXPORT void JNICALL Java_com_kitware_KiwiViewer_MidasNative_handleTwoTouchRotationGesture(JNIEnv * env, jobject obj,  jfloat rotation);
JNIEXPORT void JNICALL Java_com_kitware_KiwiViewer_MidasNative_handleSingleTouchDown(JNIEnv * env, jobject obj,  jfloat x, jfloat y);
JNIEXPORT void JNICALL Java_com_kitware_KiwiViewer_MidasNative_handleSingleTouchUp(JNIEnv * env, jobject obj);
JNIEXPORT void JNICALL Java_com_kitware_KiwiViewer_MidasNative_handleSingleTouchTap(JNIEnv * env, jobject obj,  jfloat x, jfloat y);
JNIEXPORT void JNICALL Java_com_kitware_KiwiViewer_MidasNative_handleDoubleTap(JNIEnv * env, jobject obj,  jfloat x, jfloat y);
JNIEXPORT void JNICALL Java_com_kitware_KiwiViewer_MidasNative_handleLongPress(JNIEnv * env, jobject obj,  jfloat x, jfloat y);
JNIEXPORT void JNICALL Java_com_kitware_KiwiViewer_MidasNative_resetCamera(JNIEnv * env, jobject obj);
JNIEXPORT void JNICALL Java_com_kitware_KiwiViewer_MidasNative_stopInertialMotion(JNIEnv * env, jobject obj);
JNIEXPORT jboolean JNICALL Java_com_kitware_KiwiViewer_MidasNative_getDatasetIsLoaded(JNIEnv* env, jobject obj);
