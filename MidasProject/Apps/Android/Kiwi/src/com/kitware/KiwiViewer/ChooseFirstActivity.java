 ...
 * 
 * function called when the GO button is pushed to display the list of Communities
 *
 * @param v view
 * */
 ...
 * 
 * function called when the Folder button is pushed, to display the list of folders/files in the device memory
 *
 * @param v view
 * */
 ...
 * 
 * function called when the Viewer button is pushed, to display to file by default 
 *
 * @param v view
 * */
 ...
 * ---------- CheckLogin----------------------------------------------------------------------------<br/>
 * 
 * With the email and the password entered in textviews, check if the login is correct and show it in a toast
 * 
 * @param View
 * 
 * */
