...
private class WaitWhileSave extends AsyncTask<String, Integer, Integer > 
  ...
  protected Integer doInBackground(String... filename) 
    ...
    mResult = MidasToolsNative.downloadItem( filename[0], mPath, DownloadFileActivity.this);
