...
SET_TARGET_PROPERTIES(vtkmkg3states PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkmkg3states-6.0"
  )
...
SET_TARGET_PROPERTIES(vtkInfovisCore PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "vtkCommonDataModel;vtkCommonSystem;vtkFiltersExtraction"
...
SET_TARGET_PROPERTIES(vtklibxml2 PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "dl;z;-lpthread;dl;m"
...
SET_TARGET_PROPERTIES(vtkHashSource PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkHashSource-6.0"
  )
...
SET_TARGET_PROPERTIES(vtkParallelCore PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "vtkIOLegacy"
...
SET_TARGET_PROPERTIES(ProcessShader PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkProcessShader-6.0"
  )
