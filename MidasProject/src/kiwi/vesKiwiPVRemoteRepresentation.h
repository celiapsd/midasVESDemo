...
#ifndef __vesKiwiPVRemoteRepresentation_h
#define __vesKiwiPVRemoteRepresentation_h
...
class vesKiwiPVRemoteRepresentation : public vesKiwiWidgetRepresentation
{
public:

  vesTypeMacro(vesKiwiPVRemoteRepresentation);
  typedef vesKiwiWidgetRepresentation Superclass;

  vesKiwiPVRemoteRepresentation();
  ~vesKiwiPVRemoteRepresentation();
...
private:
  ...
  vesKiwiPVRemoteRepresentation(const vesKiwiPVRemoteRepresentation&); // Not implemented
  void operator=(const vesKiwiPVRemoteRepresentation&); // Not implemented
